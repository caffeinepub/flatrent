...
export class Backend implements backendInterface {
    ...
    async getAvailableListings(): Promise<Array<FlatListing>> {
        if (this.processError) {
            try {
    ...
    async getListing(arg0: bigint): Promise<FlatListing> {
        if (this.processError) {
            try {
    ...
    async markListingUnavailable(arg0: MarkUnavailableInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markListingUnavailable(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async postListing(arg0: FlatListingInput): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.postListing(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
